...
class ReportStockCardReportXlsx(abstract_report_xlsx.AbstractReportXlsx):
    ...
    def _stock_card_report(self, wb, ws, ws_params, data, objects, product):
        ...
        row_pos = self._write_line(
            ...
            count=1, default_format=self.format_theader_blue_center,
           )
        row_pos = self._write_line(
        ...
        row_pos = self._write_line(
            ws, row_pos, ws_params, col_specs_section='data',
            render_space={'balance': balance},count=2)
        ...
        for line in product_lines:
            ...
            row_pos = self._write_line(
                ...
                render_space={
                    ...
                    'user_name': line.user_name or '',
                    'reference': line.reference or '',
                    'input': line.product_in or 0,
                    'output': line.product_out or 0,
                    'balance': balance,
                },
                count=3, default_format=self.format_tcell_amount_right)

ReportStockCardReportXlsx(
    'report.stock_card_report.report_stock_card_report_xlsx',
