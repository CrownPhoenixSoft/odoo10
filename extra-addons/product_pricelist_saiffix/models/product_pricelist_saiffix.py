...
#
# following complete method is added here for Saif Al lama Multi Company Multi Currency scenario, being addressed,
# as its each company has base cost assigned in standard_cost field in different currency by use of Company Properties
# so company currency is to be used instead of the product currency
#   price = ~~~~self~~~~.currency_id.compute(price, self.currency_id, round=False)
