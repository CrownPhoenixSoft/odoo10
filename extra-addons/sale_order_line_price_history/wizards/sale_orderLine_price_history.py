...
class SaleOrderLinePriceHistoryline(models.TransientModel):
    ...
    set_product_price = fields.Boolean(string="Set Price")
    ...
    @api.onchange('set_product_price')
    def action_set_price_onchange(self):
        self.ensure_one()
        self.history_sale_order_line_id.write({'price_unit':self.price_unit})
