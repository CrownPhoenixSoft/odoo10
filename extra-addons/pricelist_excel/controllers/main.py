...
class PricelistExcelController(http.Controller):
    @http.route(['/pricelist_excel',
                 '/pricelist_excel/<int:id>',
                 '/pricelist_excel/<int:id>/<string:filename>'], type='http', auth='user')
    def pricelist_excel(self, id=None, model='ir.attachment', output_format='xlsx', report_name=None, token=None, report_id=None, filename=None, download=None, **kw):
