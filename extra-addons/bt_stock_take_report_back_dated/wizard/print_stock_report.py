...
class StockReport(models.TransientModel):
    ...
    def action_print_stock_report(self):
        ...
        for wizard in self:
            ...
            worksheet.write_merge(0,0,0,5, report_head, xlwt.easyxf('font:height 300; align: vertical center; align: horiz center;pattern: pattern solid, fore_color black; font: color white; font:bold True;' "borders: top thin,bottom thin"))
            worksheet.write(1, 0, _('Internal Reference'), column_heading_style)
            worksheet.write(1, 1, _('Category'), column_heading_style)

            worksheet.write(1, 2, _('Product'), column_heading_style) 
            worksheet.write(1, 3, _('Quantity On Hand'), column_heading_style)
            worksheet.write(1, 4, _('Cost'), column_heading_style)
            worksheet.write(1, 5, _('Subtotal'), column_heading_style)
            ...
            for product in product_objs:
                if product.qty_available > 0:
                    ...
                    worksheet.write(row, 5, product.qty_available*product.standard_price)
